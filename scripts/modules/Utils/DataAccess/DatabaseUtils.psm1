...
function New-ComparisonWhereClause {
    ...
    foreach ($table1Column in $table1Columns) {
        ...
        elseif ($ComparisonType -eq "same") {
            $conditions += "(($Table1Alias.$escapedTable1Column = $Table2Alias.$escapedTable2Column) OR ($Table1Alias.$escapedTable1Column IS NULL AND $Table2Alias.$escapedTable2Column IS NULL))"
        }
    }
